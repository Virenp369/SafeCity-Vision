...
"""
    ...
    st.info("Forecast outputs shown in simulation mode for demonstration purposes and do not represent live operational predictions.")
    
    col1, col2 = st.columns(2, gap="large")
    with col1:
        st.markdown("<h3 style='margin-bottom: 16px; font-size: 1.25rem;'>72-Hour Demonstration Forecast</h3>", unsafe_allow_html=True)
        forecast_html = """
...
<span style="color: #EF4444; font-weight: 700;">Simulated Risk Score: 84/100</span>
</div>
...
"""
    ...
    with col2:
        st.markdown("<h3 style='margin-bottom: 16px; font-size: 1.25rem;'>Illustrative Scenario Output</h3>", unsafe_allow_html=True)
        scores_html = """
...
<span style="font-size: 0.9rem; color: #10B981; font-weight: 600;">82/100</span>
</div>
...
<span style="font-size: 0.9rem; color: #10B981; font-weight: 600;">88/100</span>
</div>
<div style="width: 100%; height: 6px; background: rgba(255,255,255,0.1); border-radius: 4px;">
...
<span style="font-size: 0.9rem; color: #38BDF8; font-weight: 600;">94/100</span>
</div>
<div style="width: 100%; height: 6px; background: rgba(255,255,255,0.1); border-radius: 4px;">
